...
// $("body").append(tela);
$("#intro").append(c3.canvas);
writeText(c2.canvas, c2.context, "Saturnus\nGo")
...
class Particle{
  constructor(canvas, options){
    ...
    this.color  = this.radius > 5 ? "#C0C0C0" : "#B0B0B0" //this.randomColor()
  }
...
function writeText(canvas, context, text){
  let size = 80; // Измените значение на желаемый размер шрифта
  context.font = size + "px Montserrat";
  context.fillStyle = "#111111";
  context.textAlign = "center";
  let lineheight = 56; // Измените значение lineheight соответственно
